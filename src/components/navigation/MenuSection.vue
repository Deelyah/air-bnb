<template>
  <div class="ml-auto items-center justify-end hidden md:flex">
    <button
      class="pl-5 pr-1 text-sm whitespace-nowrap text-[#222] font-semibold"
    >
      Airbnb your home
    </button>
    <div class="px-3.5 py-3 flex items-center justify-center">
      <svg
    ...
    <button class="rounded-full border flex items-center py-1.5 px-2 ml-1">
      <div class="pl-1 pr-3">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 32 32"
      ...
      <svg
        ...
        role="presentation"
        focusable="false"
        style="display: block; height: 30px; width: 30px; fill: #717171"
      >
        <path
